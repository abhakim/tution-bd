...
from .models import Comment, Contact,Post,Subject,Class_in,PostFile,District
...
class PostAdmin(admin.ModelAdmin):
    ...
    list_display = ('user','title_html_display','title','created_at','salary','created_since','get_subjects','get_class_in')
